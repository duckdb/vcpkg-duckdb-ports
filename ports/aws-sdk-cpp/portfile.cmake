...
vcpkg_from_github(
    ...
    PATCHES
        # Unchanged support files from vcpkg 2026.06.24 are kept in upstream/.
        upstream/fix-aws-root.patch
        upstream/lock-curl-http-and-tls-settings.patch
        upstream/fix_find_curl.patch
        upstream/find-dependency.patch
        upstream/configure-binary-dir.patch # https://github.com/aws/aws-sdk-cpp/pull/3459
        # DuckDB-specific backports.
        patches/fix-crt-credentials-expiration.patch # https://github.com/aws/aws-sdk-cpp/pull/3922
)
...
configure_file("${CURRENT_PORT_DIR}/upstream/usage" "${CURRENT_PACKAGES_DIR}/share/${PORT}/usage" @ONLY)
